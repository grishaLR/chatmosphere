...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in translator_pb2_grpc.py depends on'
...
class TranslationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Translate = channel.unary_unary(
                '/nllb.TranslationService/Translate',
...
def add_TranslationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'nllb.TranslationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('nllb.TranslationService', rpc_method_handlers)
